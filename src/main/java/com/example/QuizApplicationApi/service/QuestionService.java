...
public class QuestionService {
    ...
    public void deleteQuestionById(Integer questionId) {
        Question question=this.questionDto.findById(questionId).orElseThrow(()-> new QuestionNotFoundException("not Found by this question"+questionId));
    ...
    public Question updateQuestion(Question question,Integer questionId) {
        ...
        Question toupdatequestion=questionDto.findById(questionId).orElseThrow(()->new QuestionNotFoundException("Not Found at Id" + questionId));
...
//
    ...
    public ResponseEntity<Question> getQuestion(Integer  id) {
        Question question=this.questionDto.findById(id).orElseThrow(()->new QuestionNotFoundException("question not found by this id"+ id));
